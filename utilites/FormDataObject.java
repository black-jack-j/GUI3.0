...
public class FormDataObject<T> {
	...
	public static <T extends Control> T getFormedControl(FormAttachment left, int top, int right, int bottom, Class<T> object, Composite parent, int style){
	...
	public static <T extends Control> T getFormedControl(int left, FormAttachment top, int right, int bottom, Class<T> object, Composite parent, int style){
	...
	public static <T extends Control> T getFormedControl(int left, int top, FormAttachment right, int bottom, Class<T> object, Composite parent, int style){
	...
	public static <T extends Control> T getFormedControl(int left, int top, int right, FormAttachment bottom, Class<T> object, Composite parent, int style){
	...
	public static <T extends Control> T getFormedControl(FormAttachment left, FormAttachment top, 
											FormAttachment right, FormAttachment button, Class<T> object, Composite parent, int style){
		try {
			Constructor<T> constr = object.getConstructor(Composite.class, int.class);
			T control = constr.newInstance(parent, style);
			FormData fd = new FormData();
	...
	public static <T extends Scrollable> T getFormedComposite(int left, int top, int right, int bottom, Class<T> object, Composite parent, int style){
		try {
			Constructor<T> constr = object.getConstructor(Composite.class, int.class);
			T control = constr.newInstance(parent, style);
			FormData fd = new FormData();
	...
	public static <T extends Scrollable> T getFormedComposite(FormAttachment left, int top, int right, int bottom, Class<T> object, Composite parent, int style){
	...
	public static <T extends Scrollable> T getFormedComposite(int left, FormAttachment top, int right, int bottom, Class<T> object, Composite parent, int style){
	...
	public static <T extends Scrollable> T getFormedComposite(int left, int top, FormAttachment right, int bottom, Class<T> object, Composite parent, int style){
	...
	public static <T extends Scrollable> T getFormedComposite(int left, int top, int right, FormAttachment bottom, Class<T> object, Composite parent, int style){
